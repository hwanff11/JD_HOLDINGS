...
Telegram 운영 화면의 자산 설명과 가독성을 개선하고 있습니다. 백테스트·대시보드·포트폴리오에 현금, 보유 평가액, 순손익과 종목별 상세를 추가하고 오전 7시 배분/HWM 단문을 하나의 일일 운용보고로 통합합니다. 주문 감시·정합성 점검·안전 경고의 1분 주기와 live 잠금은 유지합니다.
