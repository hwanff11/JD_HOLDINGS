...
## 2026-08-11 최종 재검증 결과

최신 `main` 커밋 `9c84a0e`을 GitHub Actions run `31504080666`에서 2011-01-01~2026-08-10, 기본 슬리피지 0.10%로 실행했다. Issue #36 댓글과 Artifact `jdss-backtest-31504080666`의 JSON이 일치했다.

| 초기자산 | 최종자산 | 누적수익 | CAGR | MDD | Sharpe | Sortino | 평균노출 |
|---:|---:|---:|---:|---:|---:|---:|---:|
| $20,000.00 | $155,234.84 | +676.17% | +14.04% | -28.29% | 0.834 | 1.003 | 25.33% |
...
| 연도 | 수익률 | 연도 | 수익률 |
|---:|---:|---:|---:|
| 2011 | -5.71% | 2019 | +14.47% |
| 2012 | -3.35% | 2020 | +19.25% |
| 2013 | +28.13% | 2021 | +27.99% |
| 2014 | +23.48% | 2022 | -10.40% |
| 2015 | -4.59% | 2023 | +30.22% |
| 2016 | +12.40% | 2024 | +16.93% |
| 2017 | +31.42% | 2025 | +17.62% |
| 2018 | -0.71% | 2026 | +33.86% |

2026 수치는 8월 10일까지의 부분연도다. 이 결과는 탈락한 반월 후보의 기준 슬리피지 누적 +657.61%보다 높고, MDD도 -30.44%보다 작았지만 서로 다른 최종 구현을 사후 비교한 값이므로 새로운 선택 기준으로 과대해석하지 않는다.
...
GitHub에서는 저장소 소유자가 `[backtest-v3]`로 시작하는 이슈를 열면 최신 `main`으로 같은 검증을 실행하고 JSON·Markdown Artifact와 이슈 댓글을 남긴다.
