...
- 상태: 텔레그램 `/bt` 백테스트 시 데이터 부족 종목(`MarketDataError`) 대응 및 데이터 있는 만큼만 진행 안내 문구 반영 완료, 57개 테스트 통과.
- 마지막 관련 커밋: `1a3c44f` (`feat: add user-friendly error handling for insufficient backtest data`)
