...
- 텔레그램 백테스트(`/bt`) 매매 내역 UI 최종 개편 완료:
  - 헷갈리던 '매수신호' 중복 출력 줄 완전히 제거 (타임라인 최적화)
  - 매수 체결 및 미체결 내역 자체에 `[점수]`를 통합하여 1줄로 표시 (`🟢[260708][1차매수][68점][25주][$159.37]`)
...
- 마지막 관련 커밋: `670c27b` (`style: remove separate signal lines and merge score into trades/skipped in backtest timeline`)
