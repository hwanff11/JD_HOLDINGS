...
def _v31_guide_cards() -> tuple[str, ...]:
    ...
    return (
        (
            ...
            "• JDSS 초기 관리배정금 <code>$20,000</code>을 코어·부스터·SGOV로 함께 관리합니다.\n"
            "• <b>월간 코어</b>: QQQ·SOXX 월말 종가가 6개월 이동평균 위이면 "
            "TQQQ·SOXL을 첫 달 10%, 추세 유지 시 15%까지 운용합니다.\n"
            "• 비중은 전체 Toss 잔고가 아니라 <b>JDSS managed equity</b>를 기준으로 합니다.\n"
        ...
        (
            "🛡️ <b>[관리계좌·안전모드]</b>\n\n"
            "• 개인 USD 현금과 개인 SGOV는 JDSS 관리금액과 분리합니다.\n"
            "• 같은 계좌의 개인 TQQQ·SOXL 혼합 보유는 지원하지 않습니다.\n"
            "• 종목 또는 SGOV SAFE_MODE에서는 기존 코어 신호까지 신규매수를 차단합니다.\n"
            "• 코어 승인 직전에는 신호 계획주수와 현재 잔여 목표주수를 다시 비교합니다."
        ),
        (
            "📊 <b>[점수와 지표]</b>\n\n"
